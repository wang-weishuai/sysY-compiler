...
{
       0,    15,    15,    18,    24,    29,    35,    43,    49,    52,
      56,    60,    65,    70,    75,    82,    89,    93,    95,   100,
     105,   110,   115,   122,   128,   134,   140,   146,   152,   153,
     158,   162,   168,   174,   180,   186,   192,   198,   205,   207
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GOTO", "STORE", "LOAD", "LOADADDR", "MALLOC", "FUNC", "END", "CALL",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* root: program  */
#line 16 "Tigger2RISCV.y"
                                { SyntaxTree = yyvsp[0]; }
#line 1159 "Tigger2RISCV.tab.cpp"
    break;

  case 3: /* program: stmt program  */
#line 19 "Tigger2RISCV.y"
                                { yyval = NewNode(Seq_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				  yyvsp[-1]->global = true;
				}
#line 1169 "Tigger2RISCV.tab.cpp"
    break;

  case 4: /* program: func program  */
#line 25 "Tigger2RISCV.y"
                                { yyval = NewNode(Seq_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1178 "Tigger2RISCV.tab.cpp"
    break;

  case 5: /* program: func  */
#line 30 "Tigger2RISCV.y"
                                { yyval = NewNode(Seq_K);
				  yyval->child[0] = yyvsp[0];
				}
#line 1186 "Tigger2RISCV.tab.cpp"
    break;

  case 6: /* func: FUNC '[' INT ']' '[' INT ']' stmt_seq END FUNC  */
#line 36 "Tigger2RISCV.y"
                                { yyval = yyvsp[-9];
				  yyval->child[0] = yyvsp[-7];
				  yyval->child[1] = yyvsp[-4];
				  yyval->child[2] = yyvsp[-2];
				}
#line 1196 "Tigger2RISCV.tab.cpp"
    break;

  case 7: /* stmt_seq: stmt_seq stmt  */
#line 44 "Tigger2RISCV.y"
                                {
				  	yyval = NewNode(Seq_K);
				  	yyval->child[0] = yyvsp[-1];
					yyval->child[1] = yyvsp[0];
				}
#line 1206 "Tigger2RISCV.tab.cpp"
    break;

  case 8: /* stmt_seq: %empty  */
#line 49 "Tigger2RISCV.y"
                           { yyval = NULL; }
#line 1212 "Tigger2RISCV.tab.cpp"
    break;

  case 9: /* stmt: LABEL ':'  */
#line 53 "Tigger2RISCV.y"
                                { yyval = NewNode(Label_K);
				  yyval->child[0] = yyvsp[-1];
				}
#line 1220 "Tigger2RISCV.tab.cpp"
    break;

  case 10: /* stmt: GOTO LABEL  */
#line 57 "Tigger2RISCV.y"
                                { yyval = NewNode(Goto_K);
				  yyval->child[0] = yyvsp[0];
				}
#line 1228 "Tigger2RISCV.tab.cpp"
    break;

  case 11: /* stmt: IF LogicExp GOTO LABEL  */
#line 61 "Tigger2RISCV.y"
                                { yyval = NewNode(If_K);
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1237 "Tigger2RISCV.tab.cpp"
    break;

  case 12: /* stmt: VAR '=' exp  */
#line 66 "Tigger2RISCV.y"
                                { yyval = NewNode(Assign_K);
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1246 "Tigger2RISCV.tab.cpp"
    break;

  case 13: /* stmt: VAR '=' MALLOC INT  */
#line 71 "Tigger2RISCV.y"
                                { yyval = NewNode(Def_K);
				  yyval->child[0] = yyvsp[-3];
				  yyval->child[1] = yyvsp[0];
				}
#line 1255 "Tigger2RISCV.tab.cpp"
    break;

  case 14: /* stmt: VAR '[' val ']' '=' val  */
#line 76 "Tigger2RISCV.y"
                                { yyval = NewNode(Assign_K);
				  yyval->child[0] = NewNode(Array_K);
				  yyval->child[0]->child[0] = yyvsp[-5];
				  yyval->child[0]->child[1] = yyvsp[-3];
				  yyval->child[1] = yyvsp[0];
				}
#line 1266 "Tigger2RISCV.tab.cpp"
    break;

  case 15: /* stmt: VAR '=' VAR '[' val ']'  */
#line 83 "Tigger2RISCV.y"
                                { yyval = NewNode(Assign_K);
				  yyval->child[0] = yyvsp[-5];
				  yyval->child[1] = NewNode(Array_K);
				  yyval->child[1]->child[0] = yyvsp[-3];
				  yyval->child[1]->child[1] = yyvsp[-1];
				}
#line 1277 "Tigger2RISCV.tab.cpp"
    break;

  case 16: /* stmt: CALL FUNC  */
#line 90 "Tigger2RISCV.y"
                                { yyval = NewNode(OFunc_K);
				  yyval->child[0] = yyvsp[0];
				}
#line 1285 "Tigger2RISCV.tab.cpp"
    break;

  case 17: /* stmt: RETURN  */
#line 94 "Tigger2RISCV.y"
                                { yyval = NewNode(Return_K); }
#line 1291 "Tigger2RISCV.tab.cpp"
    break;

  case 18: /* stmt: STORE VAR INT  */
#line 96 "Tigger2RISCV.y"
                                { yyval = NewNode(Store_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1300 "Tigger2RISCV.tab.cpp"
    break;

  case 19: /* stmt: LOAD INT VAR  */
#line 101 "Tigger2RISCV.y"
                                { yyval = NewNode(Load_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1309 "Tigger2RISCV.tab.cpp"
    break;

  case 20: /* stmt: LOADADDR INT VAR  */
#line 106 "Tigger2RISCV.y"
                                { yyval = NewNode(Loadaddr_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1318 "Tigger2RISCV.tab.cpp"
    break;

  case 21: /* stmt: LOAD VAR VAR  */
#line 111 "Tigger2RISCV.y"
                                { yyval = NewNode(Load_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1327 "Tigger2RISCV.tab.cpp"
    break;

  case 22: /* stmt: LOADADDR VAR VAR  */
#line 116 "Tigger2RISCV.y"
                                { yyval = NewNode(Loadaddr_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1336 "Tigger2RISCV.tab.cpp"
    break;

  case 23: /* exp: val '+' val  */
#line 123 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Plus;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1346 "Tigger2RISCV.tab.cpp"
    break;

  case 24: /* exp: val '-' val  */
#line 129 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Minus;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1356 "Tigger2RISCV.tab.cpp"
    break;

  case 25: /* exp: val '*' val  */
#line 135 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Times;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1366 "Tigger2RISCV.tab.cpp"
    break;

  case 26: /* exp: val '/' val  */
#line 141 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Over;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1376 "Tigger2RISCV.tab.cpp"
    break;

  case 27: /* exp: val '%' val  */
#line 147 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Mod;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1386 "Tigger2RISCV.tab.cpp"
    break;

  case 29: /* exp: '-' val  */
#line 154 "Tigger2RISCV.y"
                                { yyval = NewNode(SOp_K);
				  yyval->attr.op = Minus;
				  yyval->child[0] = yyvsp[0];
				}
#line 1395 "Tigger2RISCV.tab.cpp"
    break;

  case 30: /* exp: val  */
#line 159 "Tigger2RISCV.y"
                                { yyval = yyvsp[0]; }
#line 1401 "Tigger2RISCV.tab.cpp"
    break;

  case 31: /* LogicExp: val AND val  */
#line 163 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = And;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1411 "Tigger2RISCV.tab.cpp"
    break;

  case 32: /* LogicExp: val OR val  */
#line 169 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Or;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1421 "Tigger2RISCV.tab.cpp"
    break;

  case 33: /* LogicExp: val '>' val  */
#line 175 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Gt;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1431 "Tigger2RISCV.tab.cpp"
    break;

  case 34: /* LogicExp: val '<' val  */
#line 181 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Lt;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1441 "Tigger2RISCV.tab.cpp"
    break;

  case 35: /* LogicExp: val EQ val  */
#line 187 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Eq;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1451 "Tigger2RISCV.tab.cpp"
    break;

  case 36: /* LogicExp: val NEQ val  */
#line 193 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Neq;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1461 "Tigger2RISCV.tab.cpp"
    break;

  case 37: /* LogicExp: '!' val  */
#line 199 "Tigger2RISCV.y"
                                { yyval = NewNode(SOp_K);
				  yyval->attr.op = Not;
				  yyval->child[0] = yyvsp[0];
				}
#line 1470 "Tigger2RISCV.tab.cpp"
    break;

  case 38: /* val: VAR  */
#line 206 "Tigger2RISCV.y"
                                { yyval = yyvsp[0]; }
#line 1476 "Tigger2RISCV.tab.cpp"
    break;

  case 39: /* val: INT  */
#line 208 "Tigger2RISCV.y"
                                { yyval = yyvsp[0]; }
#line 1482 "Tigger2RISCV.tab.cpp"
    break;


#line 1486 "Tigger2RISCV.tab.cpp"
