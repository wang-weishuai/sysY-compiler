...
#line 1170 "Tigger2RISCV.tab.cpp"
    break;

  case 4: /* program: func program  */
#line 26 "Tigger2RISCV.y"
                                {
				  yyval = NewNode(Seq_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1180 "Tigger2RISCV.tab.cpp"
    break;

  case 5: /* program: func  */
#line 32 "Tigger2RISCV.y"
                                { 
				  yyval = NewNode(Seq_K);
				  yyval->child[0] = yyvsp[0];
				}
#line 1189 "Tigger2RISCV.tab.cpp"
    break;

  case 6: /* func: FUN '[' INT ']' '[' INT ']' stmt_seq END FUN  */
#line 39 "Tigger2RISCV.y"
                                { 
				  yyval = yyvsp[-9];
...
#line 1200 "Tigger2RISCV.tab.cpp"
    break;

  case 7: /* stmt_seq: stmt_seq stmt  */
#line 48 "Tigger2RISCV.y"
                                {
				  	yyval = NewNode(Seq_K);
				  	yyval->child[0] = yyvsp[-1];
					yyval->child[1] = yyvsp[0];
				}
#line 1210 "Tigger2RISCV.tab.cpp"
    break;

  case 8: /* stmt_seq: %empty  */
#line 53 "Tigger2RISCV.y"
                           { yyval = NULL; }
#line 1216 "Tigger2RISCV.tab.cpp"
    break;
...
#line 1224 "Tigger2RISCV.tab.cpp"
    break;
...
#line 1232 "Tigger2RISCV.tab.cpp"
    break;

  case 11: /* stmt: IF LogicExp GOTO LABEL  */
#line 65 "Tigger2RISCV.y"
                                { yyval = NewNode(If_K);
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1241 "Tigger2RISCV.tab.cpp"
    break;

  case 12: /* stmt: VAR '=' exp  */
#line 70 "Tigger2RISCV.y"
                                { yyval = NewNode(Assign_K);
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1250 "Tigger2RISCV.tab.cpp"
    break;

  case 13: /* stmt: VAR '=' MALLOC INT  */
#line 75 "Tigger2RISCV.y"
                                { yyval = NewNode(Def_K);
				  yyval->child[0] = yyvsp[-3];
				  yyval->child[1] = yyvsp[0];
				}
#line 1259 "Tigger2RISCV.tab.cpp"
    break;

  case 14: /* stmt: VAR '[' val ']' '=' val  */
#line 80 "Tigger2RISCV.y"
                                { yyval = NewNode(Assign_K);
...
#line 1270 "Tigger2RISCV.tab.cpp"
    break;

  case 15: /* stmt: VAR '=' VAR '[' val ']'  */
#line 87 "Tigger2RISCV.y"
                                { yyval = NewNode(Assign_K);
...
#line 1281 "Tigger2RISCV.tab.cpp"
    break;
...
#line 1289 "Tigger2RISCV.tab.cpp"
    break;

  case 17: /* stmt: RETURN  */
#line 98 "Tigger2RISCV.y"
                                { yyval = NewNode(Return_K); }
#line 1295 "Tigger2RISCV.tab.cpp"
    break;

  case 18: /* stmt: STORE VAR INT  */
#line 100 "Tigger2RISCV.y"
                                { yyval = NewNode(Store_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1304 "Tigger2RISCV.tab.cpp"
    break;

  case 19: /* stmt: LOAD INT VAR  */
#line 105 "Tigger2RISCV.y"
                                { yyval = NewNode(Load_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1313 "Tigger2RISCV.tab.cpp"
    break;

  case 20: /* stmt: LOADADDR INT VAR  */
#line 110 "Tigger2RISCV.y"
                                { yyval = NewNode(Loadaddr_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1322 "Tigger2RISCV.tab.cpp"
    break;

  case 21: /* stmt: LOAD VAR VAR  */
#line 115 "Tigger2RISCV.y"
                                { yyval = NewNode(Load_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1331 "Tigger2RISCV.tab.cpp"
    break;

  case 22: /* stmt: LOADADDR VAR VAR  */
#line 120 "Tigger2RISCV.y"
                                { yyval = NewNode(Loadaddr_K);
				  yyval->child[0] = yyvsp[-1];
				  yyval->child[1] = yyvsp[0];
				}
#line 1340 "Tigger2RISCV.tab.cpp"
    break;

  case 23: /* exp: val '+' val  */
#line 127 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Plus;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1350 "Tigger2RISCV.tab.cpp"
    break;

  case 24: /* exp: val '-' val  */
#line 133 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Minus;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1360 "Tigger2RISCV.tab.cpp"
    break;

  case 25: /* exp: val '*' val  */
#line 139 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Times;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1370 "Tigger2RISCV.tab.cpp"
    break;

  case 26: /* exp: val '/' val  */
#line 145 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Over;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1380 "Tigger2RISCV.tab.cpp"
    break;

  case 27: /* exp: val '%' val  */
#line 151 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Mod;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1390 "Tigger2RISCV.tab.cpp"
    break;

  case 29: /* exp: '-' val  */
#line 158 "Tigger2RISCV.y"
                                { yyval = NewNode(SOp_K);
				  yyval->attr.op = Minus;
				  yyval->child[0] = yyvsp[0];
				}
#line 1399 "Tigger2RISCV.tab.cpp"
    break;

  case 30: /* exp: val  */
#line 163 "Tigger2RISCV.y"
                                { yyval = yyvsp[0]; }
#line 1405 "Tigger2RISCV.tab.cpp"
    break;

  case 31: /* LogicExp: val AND val  */
#line 167 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = And;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1415 "Tigger2RISCV.tab.cpp"
    break;

  case 32: /* LogicExp: val OR val  */
#line 173 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Or;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1425 "Tigger2RISCV.tab.cpp"
    break;

  case 33: /* LogicExp: val '>' val  */
#line 179 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Gt;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1435 "Tigger2RISCV.tab.cpp"
    break;

  case 34: /* LogicExp: val '<' val  */
#line 185 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Lt;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1445 "Tigger2RISCV.tab.cpp"
    break;

  case 35: /* LogicExp: val EQ val  */
#line 191 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Eq;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1455 "Tigger2RISCV.tab.cpp"
    break;

  case 36: /* LogicExp: val NEQ val  */
#line 197 "Tigger2RISCV.y"
                                { yyval = NewNode(DOp_K);
				  yyval->attr.op = Neq;
				  yyval->child[0] = yyvsp[-2];
				  yyval->child[1] = yyvsp[0];
				}
#line 1465 "Tigger2RISCV.tab.cpp"
    break;

  case 37: /* LogicExp: '!' val  */
#line 203 "Tigger2RISCV.y"
                                { yyval = NewNode(SOp_K);
				  yyval->attr.op = Not;
				  yyval->child[0] = yyvsp[0];
				}
#line 1474 "Tigger2RISCV.tab.cpp"
    break;

  case 38: /* val: VAR  */
#line 210 "Tigger2RISCV.y"
                                { yyval = yyvsp[0]; }
#line 1480 "Tigger2RISCV.tab.cpp"
    break;

  case 39: /* val: INT  */
#line 212 "Tigger2RISCV.y"
                                { yyval = yyvsp[0]; }
#line 1486 "Tigger2RISCV.tab.cpp"
    break;


#line 1490 "Tigger2RISCV.tab.cpp"
