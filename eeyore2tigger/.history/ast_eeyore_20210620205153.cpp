...
/*
    ...
    for(auto i : globalVar){
        if(i.second.isArray==false){
            tiggerCode.push_back(i.second.tiggerName + " = 草草草" + convert2string(i.second.val));
        }else{
            tiggerCode.push_back(i.second.tiggerName + " = malloc 哈哈哈" + convert2string(i.second.arrNum));
        }
    }
    */
