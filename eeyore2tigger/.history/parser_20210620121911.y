...
%token <token> FUNCTION OP NUM LABEL ASSIGN VAR PARAM SYMBOLEND IF GOTO CALL RETURN LCOMMA RCOMMA COLON

%type <ast> Program Declaration Initialization FunctionDef FunctionHeader Statements FunctionEnd  Expression RightValue
