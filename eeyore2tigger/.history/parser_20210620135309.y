...
Program         : Program Declaration
                    {
                        $$ = new ProgramAST($1,$2,NULL,NULL);
                    }
                | Program Initialization 
                    {                  
                        $$ = new ProgramAST($1,NULL,$2,NULL);
                    }
                | Program FunctionDef
                    {
                        $$ = new ProgramAST($1,NULL,NULL,$2);
                    }
                | Declaration 
                    {
                        $$ =  new ProgramAST(NULL,$1,NULL,NULL);
                        *root = $$;
                    }
                | Initialization 
                    {
                        $$ = new ProgramAST(NULL,NULL,S1,NULL);
                        *root = $$;
                    }
                | FunctionDef
                    {
                        $$ = new ProgramAST(NULL,NULL,NULL,$1);
                        *root = $$;
                    }
                ;
