...
Declaration     : 
VAR SYMBOL{$$ = new DefVarAST($2->tokenString,$2->isTemp);}
|VAR NUM SYMBOL{$$ = new DefVarAST($3->tokenString,$2->tokenString,$3->isTemp);}

;

Initialization  : 
SYMBOL ASSIGN NUM{$$ = new InitAST($1->tokenString, convert2int($3->tokenString));}
|SYMBOL LCOMMA NUM RCOMMA ASSIGN NUM{$$ = new InitAST($1->tokenString, convert2int($3->tokenString), convert2int($6->tokenString));}
