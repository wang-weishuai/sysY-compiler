...
Expression      : SYMBOL ASSIGN RightValue OP RightValue
                ...
                | SYMBOL ASSIGN RightValue
                    {
                        $$ = new AssignAST($1->tokenString, "" , dynamic_cast<RightValueAST*>($3), NULL, 1);
                    }
                ...
                | SYMBOL ASSIGN SYMBOL LCOMMA RightValue RCOMMA
                    {
                        $$ = new AssignAST($1->tokenString, $3->tokenString, NULL, dynamic_cast<RightValueAST*>($5), 3);
                    }
                ...
                | CALL FUNCTION
                    {
                        $$ = new CallAST("", $2->tokenString,false,Exp);
                    }
                | SYMBOL ASSIGN CALL FUNCTION
                    {
                        $$ = new CallAST($1->tokenString, $4->tokenString,true,Exp);
                    }
                | RETURN RightValue
                    {
